...
using LiteDevelop.Framework.FileSystem.Projects.MSBuild;
...
namespace LiteDevelop.Framework.FileSystem.Projects.Net
{
    ...
    /// </summary>
    public abstract class NetProject : MSBuildProject, IRootNamespaceProvider
    {
        ...
        #region IRootNamespaceProvider Members
        /// <inheritdoc />
